        ...
        <div class="group lg:px-4 xl:px-0 grid grid-cols-1 lg:grid-cols-2 md:gap-4 items-center text-green-800 text-md transition-all duration-500">
            ...
            <div class="text-center">
                <img
                    ...
                    src="/uploads/cay-sam.svg" alt="Giá trị của cây sâm" width="200" height="200" class="mx-auto h-48 group-hover:brightness-110 transition-all animate-fade-up"  loading="lazy"/>
                <h2
            ...
            <div class="text-right">
                <video class="lg:rounded-2xl lg:drop-shadow-xl" width="1920" height="1080" loop autoplay muted playsinline>
