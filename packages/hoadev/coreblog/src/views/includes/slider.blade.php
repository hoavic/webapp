<div
    ...
    <ul x-ref="scroller" class="relative w-full m-0 flex snap-x snap-mandatory overflow-x-auto scrollbar-hide scroll-smooth bg-green-100">
        <li class="w-full snap-start shrink-0">
            <a href="#" class="">
                <img src="/uploads/banner-2.webp"
