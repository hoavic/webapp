<a href="{{ route('home') }}">
    ...
    <img src="/uploads/logo-web.png" width="513" height="200" alt="logo Default"
        class="m-0 pr-4 lg:mr-8 w-40 xl:w-56 h-auto transition-all duration-300"
        :class="{'xl:w-56': !atTop, 'xl:w-40': atTop}"/>
</a>
